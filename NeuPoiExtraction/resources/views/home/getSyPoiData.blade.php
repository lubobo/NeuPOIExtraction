        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-7">
                ...
                <div class="small-box bg-light-blue-gradient">
                    ...
                    <div class="small-box-footer">
                        <form method="post" action="{{route('downloadSyFile')}}">
                            <input class="hidden" name="filePath" value="{{$testPoiName}}">
            ...
            <div class="col-lg-3 col-xs-7">
                ...
                <div class="small-box bg-maroon-active">
                    ...
                    <div class="small-box-footer">
                        <form method="post" action="{{route('downloadSyFile')}}">
                            <input class="hidden" name="filePath" value="{{$testPoiIdName}}">
                            <button type="submit" class="btn-block btn btn-xs btn-google small-box-footer">
                                下载文件
                                <i class="fa fa-arrow-circle-down"></i>
                            </button>
                            {{ csrf_field() }}
                ...
                <div class="small-box bg-teal-active">
                    ...
                    <div class="small-box-footer">
                        <form method="post" action="{{route('downloadSyFile')}}">
                            ...
                            <button type="submit" class="btn-block btn btn-xs btn-vk small-box-footer">
                                下载文件
                                <i class="fa fa-arrow-circle-down"></i>
                            </button>
                            {{ csrf_field() }}
